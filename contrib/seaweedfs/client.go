...
// ref. https://github.com/chrislusf/seaweedfs
// Package seaweedfs provides a billy filesystem base on seaweedfs.
package seaweedfs // import "github.com/sniperkit/snk.fork.go-billy.v4/contrib/seaweedfs"
...
// Memory a very convenient filesystem based on seaweedfs entries
type Memory struct {
	s *storage
