...
// Package botlfs provides a billy filesystem base on boltdb.
package botlfs // import "github.com/sniperkit/snk.fork.go-billy.v4/contrib/botlfs"
...
// Memory a very convenient filesystem based on boltdb embedded files
type Memory struct {
	s *storage
