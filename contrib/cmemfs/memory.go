...
// Package cmemfs provides a billy filesystem base on thread-safe memory.
package cmemfs // import "github.com/sniperkit/snk.fork.go-billy.v4/contrib/cmemfs"
...
// Memory a very convenient filesystem based on thread-safe memory files
type Memory struct {
	s *storage
