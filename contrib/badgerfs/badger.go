...
// Package badgerfs provides a billy filesystem base on aferofs.
package badgerfs // import "github.com/sniperkit/snk.fork.go-billy.v4/contrib/badgerfs"
...
// Memory a very convenient filesystem based on badger kv embedded files
type Memory struct {
	s *storage
