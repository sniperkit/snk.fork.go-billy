...
// Package memfs provides a billy filesystem base on stormfs.
package stormfs // import "github.com/sniperkit/snk.fork.go-billy.v4/contrib/stormfs"
...
// Memory a very convenient filesystem based on stormdb embedded files
type Memory struct {
	s *storage
